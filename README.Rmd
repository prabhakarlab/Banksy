...
millions of cells with low memory usage. See the
[BANKSY matrix vignette](https://prabhakarlab.github.io/Banksy/articles/banksy-matrix.html)
for the explicit matrix construction path (required for AGF / higher harmonics).
For Seurat users, see the
[SeuratWrappers vignette](https://github.com/jleechung/seurat-wrappers/blob/feat-sparse-matmul/docs/banksy.md).
