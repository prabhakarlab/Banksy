...
plotReduction(bank, reduction = 'pca_M1_lam0.2', by = 'Cell_class', type = 'discrete')
...
p1 <- plotReduction(bank, reduction = 'umap_M1_lam0.2', by = 'Cell_class', 
...
p2 <- plotReduction(bank, reduction = 'umap_M1_lam0.2', by = clust.names(bank), 
                    type = 'discrete', pt.size = 0.25)
