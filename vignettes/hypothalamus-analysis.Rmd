...
```{r, spatial-4, fig.width=7, fig.height=8, fig.align='center'}
...
```{r, cluster, fig.width=7, fig.height=3.5, fig.align='center'}
...
```{r, heatmap, fig.width=7, fig.height=6, fig.align='center'}
set.seed(1000)
