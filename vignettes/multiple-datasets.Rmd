...
## UMAP
by <- 'res0.8_lam0.5_k35'
umap <- plotUMAP(bank, by, pt.size = 0.02, main.size = 10)
...
bankSubset <- SubsetBanksy(bank, 
                           ...
                           dataset = 'd2',
                           metadata = res0.8_lam0.5_k35 %in% c(1,3))

umap <- plotUMAP(bankSubset, by, pt.size = 0.5, main.size = 10)
