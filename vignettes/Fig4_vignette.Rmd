...
```{r, eval=F, echo=TRUE, out.width="30%", fig.cap="VeraFISH clustering"}
...
```{r, eval=F, echo=TRUE, fig.cap="VeraFISH clustering", fig.height=7, fig.width=8}
...
```{r, fig.height=20, fig.width=16, eval=F}
...
```{r, eval=F, echo=TRUE, fig.height=20, fig.width=16}
...
```{r, echo=TRUE, fig.height=20, fig.width=16, eval=F}
...
```{r, echo=TRUE, fig.height=40, fig.width=16, eval=F}
